// Version:     l3ny 1.0.2  = Jquery 1.6.1, JqueryUI 1.8.12, jquery.validate/1.8, jquery-1.6.1-vsdoc.js, jquery Mobile-1.0a4.1.js
// Name:        start.debug.js
...
return this.each(function() { \
    ...
    loader.defineScripts(null, [
     { name: "jQuery",
       releaseUrl: ajaxPath + "jquery/jquery-1.6.1.min.js",
       debugUrl: ajaxPath + "jquery/jquery-1.6.1.js",
       isLoaded: !!window.jQuery
     },
     { name: "jQueryUI",
         releaseUrl: ajaxPath + "jquery.ui/1.8.12/jquery-ui.min.js",
         debugUrl: ajaxPath + "jquery.ui/1.8.12/jquery-ui.js",
         dependencies: ["jQuery"],
         isLoaded: !!(window.jQuery && jQuery.fn.validate)
     },
     { name: "jQueryMobile",
         releaseUrl: "http://code.jquery.com/mobile/1.0a4.1/jquery.mobile-1.0a4.1.min.js",
         debugUrl: "http://code.jquery.com/mobile/1.0a4.1/jquery.mobile-1.0a4.1.js",
         dependencies: ["jQuery"],
         isLoaded: !!(window.jQuery && jQuery.fn.validate)
     },     
     { name: "jQueryValidate",
       releaseUrl: ajaxPath + "jquery.validate/1.8/jquery.validate.min.js",
       debugUrl: ajaxPath + "jquery.validate/1.8/jquery.validate.js",
       dependencies: ["jQuery"],
       isLoaded: !!(window.jQuery && jQuery.fn.validate)
     }
    ]);
